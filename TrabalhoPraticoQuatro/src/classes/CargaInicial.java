package classes;
/**Cria os dados iniciais do c�digo
 * @author Rodolfo
 */
import java.util.*;
...
{	
	/**
	 * @author Rodolfo
	 * Esta classe adiciona uma carga inicial de dados automaticamente , assim que o programa � executado
	 */
	 ...
	 * @author Rodolfo
	 * @author Marcos
	 * cadastra livros que j� estar�o no c�digo na hora de rodar o mesmo
	 */
    	...
    	/**
    	 * @author Rodolfo
    	 * cadastra revistas que j� estar�o no c�digo na hora de rodar o mesmo
    	 */
