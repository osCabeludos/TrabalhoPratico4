/**
 * Classe responsável pelo carregamento inicial dos dado.
 * <p>
 * Assim que o programa é inicializado, os dados são carregados automaticamente por intermédio destes métodos
 * @author Rodolfo
 * 
 */
...
{	
	/**
	 * 
	 * Este método retorna uma lista de clientes .
	...
	/**
	 * 
	 * Este método retorna uma lista de livros .
	...
	/**
	 * 
	 * Este método retorna uma lista de revistas .
