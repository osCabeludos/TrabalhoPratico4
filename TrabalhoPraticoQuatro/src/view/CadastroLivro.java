...
public class CadastroLivro extends javax.swing.JFrame {
    ...
    public CadastroLivro(EstoqueGeral estoqueGeral) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Genero Literario");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
      ...
      this.estoqueGeral.cadastrarLivro( new Livro(
              ...
              txtEditora.getText(),
              (int)Integer.valueOf(txtEdicao.getValue().toString()),
              (int)Integer.valueOf(txtQuantidade.getValue().toString())));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroLivro(new EstoqueGeral(new ArrayList<Livro>(),new  ArrayList<Revista>(),new ArrayList<Cliente>())).setVisible(true);
            }
        });
    }
