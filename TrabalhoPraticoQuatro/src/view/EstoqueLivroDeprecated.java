...
public class EstoqueLivroDeprecated extends javax.swing.JFrame {
    
    ArrayList<Livro> livros;
    DefaultTableModel dtmUsuarios;
    DefaultTableModel dtmLivros;
    
    public EstoqueLivroDeprecated(ArrayList<Livro> livro) 
    {
        initComponents();
        this.livros = livro;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstoqueLivroDeprecated.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new EstoqueLivroDeprecated(new ArrayList<Livro>()).setVisible(true);
        });
    }
