...
public class EstoqueRevistaDeprecated extends javax.swing.JFrame {
    
    ArrayList<Revista> revistas;
    DefaultTableModel dtmRevistas;
    
    public EstoqueRevistaDeprecated(ArrayList<Revista> revista) 
    {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstoqueRevistaDeprecated.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new EstoqueRevistaDeprecated(new ArrayList<Revista>()).setVisible(true);
        });
    }
